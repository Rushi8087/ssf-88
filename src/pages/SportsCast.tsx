...
export default function SportsCast() {
  return (
    <div className="w-full bg-black">
      ...
      <section className="snap-start snap-always min-h-[100dvh] w-full relative bg-black overflow-hidden flex items-center justify-center border-t border-royal-blue/20">
         <motion.div 
         ...
         <div className="relative z-10 text-center max-w-4xl px-8">
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-anton text-pure-white uppercase drop-shadow-2xl mb-8">
      ...
      {/* Services Grid */}
      <section className="snap-start snap-always min-h-[100dvh] py-24 px-8 bg-deep-navy flex flex-col justify-center">
         <div className="max-w-7xl mx-auto lg:ml-64 w-full">
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
               {[
                 ...
                 { title: "OTT Syndication", desc: "Direct distribution to regional and global broadcast networks." }
                  ...
                  >
                     <h3 className="text-2xl font-anton text-pure-white uppercase mb-4">{svc.title}</h3>
      ...
      <section className="snap-end snap-always min-h-[100dvh] flex flex-col justify-end w-full">
        <Footer />
      </section>
    </div>
  );
